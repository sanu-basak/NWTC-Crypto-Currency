...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "NWTCcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"nwtctools.com", "122.176.196.120"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"nwtctools.com", "testnet-seed.nwtctools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. NWTCcoin is probably already running."), addrBind.ToString().c_str());
        else
